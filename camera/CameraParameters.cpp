...
const char CameraParameters::EX_EXTENSION_VERSION[] = "1.5";
const char CameraParameters::EX_IS_AUTO[] = "auto";
const char CameraParameters::EX_IS_ON_STILL_HDR[] = "on-still-hdr";
const char CameraParameters::EX_IS_ON[] = "on";
const char CameraParameters::EX_IS_OFF[] = "off";
const char CameraParameters::EX_AE_MODE_MANUAL[] = "manual";
const char CameraParameters::EX_AE_MODE_SHUTTER_PRIO[] = "shutter-prio";
const char CameraParameters::EX_AE_MODE_ISO_PRIO[] = "iso-prio";
const char CameraParameters::EX_AE_MODE_AUTO[] = "auto";
...
const char CameraParameters::EX_SCENE_MODE_HIGH_SENSITIVITY[] = "high-sensitivity";
const char CameraParameters::EX_SCENE_MODE_HANDHELD_TWILIGHT[] = "handheld-twilight";
const char CameraParameters::EX_SCENE_MODE_ANTI_MOTION_BLUR[] = "anti-motion-blur";
const char CameraParameters::EX_SCENE_MODE_SOFT_SKIN[] = "soft-skin";
const char CameraParameters::EX_SCENE_MODE_SPOT_LIGHT[] = "spot-light";
const char CameraParameters::EX_SCENE_MODE_BABY[] = "baby";
const char CameraParameters::EX_SCENE_MODE_PET[] = "pet";
const char CameraParameters::EX_SCENE_MODE_DISH[] = "dish";
const char CameraParameters::EX_SCENE_MODE_DARK[] = "dark";
const char CameraParameters::EX_SCENE_MODE_SWEEP_STITCH[] = "sweep-stitch";
...
const char CameraParameters::KEY_EX_EXTENSION_VERSION[] = "SONY_CAMERA_HARDWARE-extension-version";
const char CameraParameters::KEY_EX_OBJECT_TRACKING_SUPPORTED[] = "SONY_CAMERA_HARDWARE-object-tracking-supported";
const char CameraParameters::KEY_EX_MAX_BURST_SHOT_SIZE[] = "SONY_CAMERA_HARDWARE-max-burst-shot-size";
const char CameraParameters::KEY_EX_SUPPORTED_BURST_SHOTS[] = "SONY_CAMERA_HARDWARE-burst-shot-values";
const char CameraParameters::KEY_EX_BURST_SHOT[] = "SONY_CAMERA_HARDWARE-burst-shot";
const char CameraParameters::KEY_EX_MAX_VIDEO_HDR_SIZE[] = "SONY_CAMERA_HARDWARE-max-video-hdr-size";
const char CameraParameters::KEY_EX_SUPPORTED_VIDEO_HDRS[] = "SONY_CAMERA_HARDWARE-video-hdr-values";
const char CameraParameters::KEY_EX_VIDEO_HDR[] = "SONY_CAMERA_HARDWARE-video-hdr";
const char CameraParameters::KEY_EX_MAX_STILL_HDR_LEVEL[] = "SONY_CAMERA_HARDWARE-max-still-hdr-level";
const char CameraParameters::KEY_EX_STILL_HDR_LEVEL[] = "SONY_CAMERA_HARDWARE-still-hdr-level";
const char CameraParameters::KEY_EX_SHUTTER_SPEED_STEP[] = "SONY_CAMERA_HARDWARE-shutter-speed-step";
const char CameraParameters::KEY_EX_MIN_SHUTTER_SPEED[] = "SONY_CAMERA_HARDWARE-min-shutter-speed";
const char CameraParameters::KEY_EX_MAX_SHUTTER_SPEED[] = "SONY_CAMERA_HARDWARE-max-shutter-speed";
const char CameraParameters::KEY_EX_SHUTTER_SPEED[] = "SONY_CAMERA_HARDWARE-shutter-speed";
const char CameraParameters::KEY_EX_SUPPORTED_ISO[] = "SONY_CAMERA_HARDWARE-iso-values";
const char CameraParameters::KEY_EX_ISO[] = "SONY_CAMERA_HARDWARE-iso";
const char CameraParameters::KEY_EX_SUPPORTED_AE_MODES[] = "SONY_CAMERA_HARDWARE-ae-mode-values";
const char CameraParameters::KEY_EX_AE_MODE[] = "SONY_CAMERA_HARDWARE-ae-mode";
const char CameraParameters::KEY_EX_MULTI_FOCUS_RECTS[] = "SONY_CAMERA_HARDWARE-multi-focus-rects";
const char CameraParameters::KEY_EX_MAX_MULTI_FOCUS_NUM[] = "SONY_CAMERA_HARDWARE-max-multi-focus-num";
const char CameraParameters::KEY_EX_SUPPORTED_FOCUS_AREAS[] = "SONY_CAMERA_HARDWARE-focus-area-values";
const char CameraParameters::KEY_EX_FOCUS_AREA[] = "SONY_CAMERA_HARDWARE-focus-area";
const char CameraParameters::KEY_EX_SUPPORTED_SMILE_DETECTIONS[] = "SONY_CAMERA_HARDWARE-smile-detect-values";
const char CameraParameters::KEY_EX_SMILE_DETECTION[] = "SONY_CAMERA_HARDWARE-smile-detect";
const char CameraParameters::KEY_EX_SCENE_DETECTION_SUPPORTED[] = "SONY_CAMERA_HARDWARE-scene-detect-supported";
const char CameraParameters::KEY_EX_SUPPORTED_VIDEO_STABILIZERS[] = "SONY_CAMERA_HARDWARE-vs-values";
const char CameraParameters::KEY_EX_VIDEO_STABILIZER[] = "SONY_CAMERA_HARDWARE-vs";
const char CameraParameters::KEY_EX_SUPPORTED_IMAGE_STABILIZERS[] = "SONY_CAMERA_HARDWARE-is-values";
const char CameraParameters::KEY_EX_IMAGE_STABILIZER[] = "SONY_CAMERA_HARDWARE-is";
const char CameraParameters::KEY_EX_SUPPORTED_METERING_MODES[] = "SONY_CAMERA_HARDWARE-metering-mode-values";
const char CameraParameters::KEY_EX_METERING_MODE[] = "SONY_CAMERA_HARDWARE-metering-mode";
#endif
