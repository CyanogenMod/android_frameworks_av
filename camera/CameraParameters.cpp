...
const char CameraParameters::KEY_EX_EXTENSION_VERSION[] = "sony-extension-version";
const char CameraParameters::KEY_EX_OBJECT_TRACKING_SUPPORTED[] = "sony-object-tracking-supported";
const char CameraParameters::KEY_EX_MAX_BURST_SHOT_SIZE[] = "sony-max-burst-shot-size";
const char CameraParameters::KEY_EX_SUPPORTED_BURST_SHOTS[] = "sony-burst-shot-values";
const char CameraParameters::KEY_EX_BURST_SHOT[] = "sony-burst-shot";
const char CameraParameters::KEY_EX_MAX_VIDEO_HDR_SIZE[] = "sony-max-video-hdr-size";
const char CameraParameters::KEY_EX_SUPPORTED_VIDEO_HDRS[] = "sony-video-hdr-values";
const char CameraParameters::KEY_EX_VIDEO_HDR[] = "sony-video-hdr";
const char CameraParameters::KEY_EX_MAX_STILL_HDR_LEVEL[] = "sony-max-still-hdr-level";
const char CameraParameters::KEY_EX_STILL_HDR_LEVEL[] = "sony-still-hdr-level";
const char CameraParameters::KEY_EX_SHUTTER_SPEED_STEP[] = "sony-shutter-speed-step";
const char CameraParameters::KEY_EX_MIN_SHUTTER_SPEED[] = "sony-min-shutter-speed";
const char CameraParameters::KEY_EX_MAX_SHUTTER_SPEED[] = "sony-max-shutter-speed";
const char CameraParameters::KEY_EX_SHUTTER_SPEED[] = "sony-shutter-speed";
const char CameraParameters::KEY_EX_SUPPORTED_ISO[] = "sony-iso-values";
const char CameraParameters::KEY_EX_ISO[] = "sony-iso";
const char CameraParameters::KEY_EX_SUPPORTED_AE_MODES[] = "sony-ae-mode-values";
const char CameraParameters::KEY_EX_AE_MODE[] = "sony-ae-mode";
const char CameraParameters::KEY_EX_MULTI_FOCUS_RECTS[] = "sony-multi-focus-rects";
const char CameraParameters::KEY_EX_MAX_MULTI_FOCUS_NUM[] = "sony-max-multi-focus-num";
const char CameraParameters::KEY_EX_SUPPORTED_FOCUS_AREAS[] = "sony-focus-area-values";
const char CameraParameters::KEY_EX_FOCUS_AREA[] = "sony-focus-area";
const char CameraParameters::KEY_EX_SUPPORTED_SMILE_DETECTIONS[] = "sony-smile-detect-values";
const char CameraParameters::KEY_EX_SMILE_DETECTION[] = "sony-smile-detect";
const char CameraParameters::KEY_EX_SCENE_DETECTION_SUPPORTED[] = "sony-scene-detect-supported";
const char CameraParameters::KEY_EX_SUPPORTED_VIDEO_STABILIZERS[] = "sony-vs-values";
const char CameraParameters::KEY_EX_VIDEO_STABILIZER[] = "sony-vs";
const char CameraParameters::KEY_EX_SUPPORTED_IMAGE_STABILIZERS[] = "sony-is-values";
const char CameraParameters::KEY_EX_IMAGE_STABILIZER[] = "sony-is";
const char CameraParameters::KEY_EX_SUPPORTED_METERING_MODES[] = "sony-metering-mode-values";
const char CameraParameters::KEY_EX_METERING_MODE[] = "sony-metering-mode";
#endif
