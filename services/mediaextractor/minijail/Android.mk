...
ifdef TARGET_2ND_ARCH
    ...
    LOCAL_SRC_FILES += $(wildcard $(LOCAL_PATH)/seccomp_policy/mediaextractor-seccomp-$(TARGET_2ND_ARCH)-cm.policy)
else
    LOCAL_SRC_FILES := $(LOCAL_PATH)/seccomp_policy/mediaextractor-seccomp-$(TARGET_ARCH).policy
    LOCAL_SRC_FILES += $(wildcard $(LOCAL_PATH)/seccomp_policy/mediaextractor-seccomp-$(TARGET_ARCH)-cm.policy)
endif
